...
final class task_aggregate_daily_stats_test extends advanced_testcase {
    ...
    /**
     * The task should insert one row in {su_statboard_daily_stats} after running, with the count
    ...
    public function test_task_inserts_yesterday_logins(): void {
        ...
        $row = $DB->get_record('su_statboard_daily_stats', ['statsdate' => $datestr]);
    ...
    public function test_task_is_idempotent_for_the_same_day(): void {
        ...
        $rows = $DB->get_records('su_statboard_daily_stats', ['statsdate' => $datestr]);
    ...
    public function test_task_purges_old_entries(): void {
        ...
        $DB->insert_record('su_statboard_daily_stats', $oldrow);
        ...
        $remaining = $DB->get_record('su_statboard_daily_stats', ['statsdate' => $oldrow->statsdate]);
